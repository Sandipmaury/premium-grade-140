    ...
    <div>
        <Box w={"100%"} bg={"white"}>
           <Box w={"100%"} bg={"#f0f0f0"} padding={"25px"} >
            ...
            <Box  w={"1100px"} m={"auto"} >
              <Text fontSize={"28px"} color={"444444"} marginBottom={"10px"} fontWeight={"normal"} fontFamily={"Open Sans Condensed"} >Yummy News, Articles & Videos</Text>
              <Box marginBottom={"10px"} fontWeight={"400"}>Want to keep updated on the latest news of delicious meat-free meals and adorable animals? Check out this section for interesting daily happenings and articles that will melt your tummy (and heart too).</Box>
              <Box>You can also follow our <span style={{color:"#2184ff"}}>Facebook Page</span>  or <span style={{color:"#2184ff"}}>Twitter</span>  for more news and updates.</Box>
            </Box>
          </Box>
             ...
             <Box w={"100%"} h={"1200px"} padding={"35px"} bg={"rgb(252,252,252)"}>
                ...
                <Box w={"730px"} h={"800px"} padding={"20px"} border={"1px solid #dddddd"} boxShadow={"rgba(99, 99, 99, 0.2) 0px 2px 8px 0px"} borderRadius={"5px"} >
                    ...
                    <Link><Image h={"36px"} w={"36px"} src="https://www.kindmeal.my/images/share_facebook.png" /></Link>   
                   <Link><Image h={"36px"} w={"36px"} src="https://www.kindmeal.my/images/share_twitter.png" /></Link>  
                    </Box>

                    <Box padding={"20px"}>
                    <Box fontSize={"22px"} marginBottom={"6px"} color={"#444444"}>Mama And Baby Elephant Get Stuck In 7 Foot Hole</Box>
                    <Text marginBottom={"25px"} color={"#999999"} >by KindMeal.my, 10 November 2022</Text>
                    <Box marginBottom={"30px"}>Mama elephant gets CPR and comes back to life to reunite with her baby. ❤</Box>
                    <Box bg={"#f53838"} justifyContent={"center"} h={"45px"} borderRadius={"5px"} display={"flex"} alignItems={"center"} w={"180px"} fontSize={"18px"} fontWeight={"bold"} color={"#ffffff"} >« Back To Articles</Box>
                </Box>
                </Box>
