  ...
  return (
    <div style={{ backgroundColor: "white", width: "100%" }}>
          ...
          <Box bg={"white"} w={"1100px"} margin={"auto"}>
           ...
           <PremiumImage/>
            ...
            >
              ...
              long as the deals and menu featured are meat-free. Enjoy a great
           ...
           <Box   m={"auto"} marginTop={"60px"} marginBottom={"60px"}>
            <Text textAlign={"center"} fontSize={"26px"} fontWeight={"bold"} color={"#888888"} >Featured On</Text>
     ...
     <Box w={"1100px"} m={"auto"} bg={"#ececec"}>
            <Image w={"100%"} m={"auto"} src="https://www.kindmeal.my/images/banner_whykindmeal.png"/>
           </Box>
